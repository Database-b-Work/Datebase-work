...
class TestImportExcel_model extends CI_Model
{
  ...
  public function insert_excel(
    ...
    $station_num,
    $meter_num,
    $straight_station_num,
    $straight_meter_num,
    $straight_fee,
    $straight_count,
    $straight_average_fee_non,
    $straight_top_fee_non,
    $straight_low_fee_non,
    $straight_top_fee,
    $straight_low_fee,
    $trans_station_num,
    $trans_meter_num,
    $trans_fee,
    $trans_count,
    $trans_average_fee_non,
    $trans_top_fee_non,
    $trans_low_fee_non,
    $trans_top_fee,
    $trans_low_fee,
    $trans_self_station_num,
    $trans_fee_self_proportion,
    $trans_replace_station_num,
    $trans_replace_proportion,
    $index_explain
  ) //
  {
    $data = array(
